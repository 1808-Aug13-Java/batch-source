...
function buildQuiz(){
    ...
    myQuestion.forEach((currentQuestion, questionNumber)=>{
        ...
        quizContent.push(`
        <div class="question"> <strong> ${questionNumber+1}.${currentQuestion.question}
        </strong></div>
...
function showResults(){
    ...
    myQuestions.forEach((currentQuestion, questionNumber)=>{
        ...
        const checkedInput = (currentAnswers.querySelector("input[name=question"+questionNumber+"]:checkd"));
