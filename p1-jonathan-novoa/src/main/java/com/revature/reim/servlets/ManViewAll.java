...
/**
 * Servlet implementation class ManViewAll
 */
public class ManViewAll extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter pw = response.getWriter();
			...
			List<Employee> reimbursementsList = man.viewAllEmployees(4);//pending reims
