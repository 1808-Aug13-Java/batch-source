...
/**
 * Servlet implementation class ManResReim
 */
public class ManResReim extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter pw = response.getWriter();
			...
			List<Reimbursement> reimbursementsList = man.viewAllRequest(2);//pending reims
