...
INSERT INTO P1_PROFILE(EMP_ID, FIRSTNAME, LASTNAME, LOC_ID, PHONE, EMAIL) VALUES (2, 'ADMIN', 'GUY', 2, 5555555555, 'admin@gmail.com');

INSERT INTO P1_REIMBURSEMENT(EMP_ID, MAN_ID, STATUS, ACTION, DESCRIPTION) VALUES (1, NULL, 'PENDING', NULL, 'Travel reimbursement');
INSERT INTO P1_REIMBURSEMENT(EMP_ID, MAN_ID, STATUS, ACTION, DESCRIPTION) VALUES (1, 2, 'RESOLVED', 'APPROVED', 'Certification reimbursement');
INSERT INTO P1_REIMBURSEMENT(EMP_ID, MAN_ID, STATUS, ACTION, DESCRIPTION) VALUES (2, NULL, 'PENDING', NULL, 'Testing reimbursement');
INSERT INTO P1_REIMBURSEMENT(EMP_ID, MAN_ID, STATUS, ACTION, DESCRIPTION) VALUES (1, NULL, 'PENDING', NULL, 'I want money');
