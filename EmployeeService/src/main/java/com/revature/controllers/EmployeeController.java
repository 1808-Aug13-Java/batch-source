...
public class EmployeeController {
	...
	public EmployeeController() {
		employees.add(new Employee(1,"Bob Bok", "bbok@email.com", null));
		employees.add(new Employee(2,"George Ross", "gross@gmail.com", null));
		employees.add(new Employee(3,"Rick Tyler", "rtyler@gmail.com", null));
		employees.add(new Employee(4,"Ivan Smith", "ismith@gmail.com", null));
	}
	...
	public Employee getEmployeeById(@PathVariable("employeeId") int employeeId) {
		...
		Employee employee = employees.stream().filter(empl -> empl.getEmployeeId() == employeeId).findFirst().get();
