...
/**
 * Servlet implementation class AllResolvedReimbursementsServlet
 */
public class AllResolvedReimbursementsServlet extends HttpServlet {
     ...
     */
    public AllResolvedReimbursementsServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(idStr != null) {
			...
			List<Reimbursement> reimbursements = rd.getResolvedRequestsById(id);
			...
			List<Reimbursement> reimbursements = rd.getAllResolvedRequests();
			String reimbursementString = om.writeValueAsString(reimbursements);
			reimbursementString = "{\"reimbursements\":"+reimbursementString+"}";
			pw.print(reimbursementString);
		}
