...
/**
 * Servlet implementation class EmployeeViewProfile
 */
public class EmployeeViewProfile extends HttpServlet {
	 ...
	 */
//    url : /emp_view_profile
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		HttpSession session = request.getSession(false);
		if(session == null) 
			response.sendRedirect("login");
		else
			request.getRequestDispatcher("Views/employeeViewProfile.html").forward(request, response);
