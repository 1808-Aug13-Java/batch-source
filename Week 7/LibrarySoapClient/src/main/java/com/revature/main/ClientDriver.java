...
public class ClientDriver {
	...
	public static void main(String[] args) {
		...
		//need to create as instance of our jaxws prxoy factory beam
		
		JaxWsProxyFactoryBean factory = new JaxWsProxyFactoryBean();
		factory.setServiceClass(Library.class);//provide the interface
		//we access the inplmentation of the interface with the endpoint
